...
# 2026年2月19日「OctoNihon Forum」

## イベント概要

第4回目のイベントとして、ソニーシティ大崎2階ホールCにて、GitHub Enterpriseユーザーをご招待して開催しました。
- 🌏 [参加登録ウェブサイト](https://github.registration.goldcast.io/events/040d8b66-6c6b-4e60-9f9c-0e4aaa217d74)
- 📍 場所：ソニーシティ大崎2階ホールC
- 👥 登壇者：
  - 大日本印刷株式会社 Engineer 加藤 瑞穂 様 / DNPデジタルソリューションズ 主幹技術員 八幡 吉明 様
  - Woven by Toyota, Inc. Cloud & AI Line of Business　Senior Cloud Engineer　Chris Sng 様
  - JCOM株式会社 次期フロントシステム開発部　専任部長　渡辺 一宏 様
  - NTTデータグループ　技術革新統括本部　AI技術部　課長代理　小林 和貴 様
  - GitHub Senior Customer Success Manager Jack Franklin
  - GitHub Senior Solutions Engineer　篠原　英治
  - ソニー株式会社 技術センター 商品設計第1部門/設計DX部門 ソフトウェアエンジニア 大崎 泰寛 様
- 📄 登壇者資料
  ...
  - NTTデータグループ　生成AIを前提とした開発変革の取り組み ― GitHub Copilot を起点とした全社展開の現状と学び ―
